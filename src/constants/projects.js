...
const projects = [
  ...
  {
    title: "REST API - PHP Nativo",
    description:
      "Esta API inspirada en la PokeAPI ha sido diseñada desde cero con PHP nativo, ofreciendo una solución simple y eficiente para quienes buscan implementar o crear una API bajo los estándares REST.",
    image: "/pokeapi.webp",
